var Datepicker = (function () {
	...
	function X(t, s) {
		...
		if (n.language) {
			...
			if (
				...
				;(h = Object.assign({ format: P, weekStart: R }, r[I])),
					...
					D === t.weekStart && ((D = a.weekStart = h.weekStart), (a.weekEnd = J(h.weekStart)))
			}
		}
		if (n.format) {
		...
		void 0 !== n.pickLevel && ((v = z(n.pickLevel, 2)), delete n.pickLevel),
			v !== g &&
				(v > g &&
					(void 0 === n.minDate && (n.minDate = p), void 0 === n.maxDate && (n.maxDate = u)),
		...
		if (
			(n.daysOfWeekDisabled &&
				((a.daysOfWeekDisabled = n.daysOfWeekDisabled.reduce(q, [])), delete n.daysOfWeekDisabled),
		...
		if (
			(void 0 !== n.disableTouchKeyboard &&
				((a.disableTouchKeyboard = "ontouchstart" in document && !!n.disableTouchKeyboard),
			...
			;(this.disabled = this.datesDisabled.map((e) => new Date(e).getFullYear())),
				...
				Array.from(this.grid.children).forEach((e, t) => {
					...
					if (
						...
						(s < this.minYear || s > this.maxYear || this.disabled.includes(s)) &&
							i.add("disabled"),
						this.range)
					) {
						const [e, t] = this.range
		...
		constructor(e) {
			...
			s.classList.add(`datepicker-${p}`),
				...
				(this.views = [
					...
					new ne(this, { id: 3, name: "decades", cellClass: "decade", step: 10 }),
				]),
			...
			if ("ArrowLeft" === i)
				...
				if ("Enter" !== i)
					return void ("Escape" === i
						? s.hide()
						: ("Backspace" !== i && "Delete" !== i && (1 !== i.length || t.ctrlKey || t.metaKey)) ||
						  e.enterEditMode())
			...
			return (
				void 0 === i ||
					...
					!n(i, s.minDate, s.maxDate) ||
						...
						(!(s.pickLevel > 0) && s.daysOfWeekDisabled.includes(new Date(i).getDay())) ||
						e.push(i)),
				e
			)
		}, [])
