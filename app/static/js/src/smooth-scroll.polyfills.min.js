							...
							var n,
								...
								g = c
									...
									: (function (e, t, n, o) {
											...
											return (
												(a = Math.max(a - t - n, 0)), o && (a = Math.min(a, F() - M.innerHeight)), a
											)
									  })(
											t,
											p,
											parseInt("function" == typeof i.offset ? i.offset(a, r) : i.offset, 10),
											i.clip
									  ),
								y = g - s,
								v = F(),
									...
									l || (l = e),
										...
										(function (e, t) {
											...
											if (e == t || n == t || (s < t && M.innerHeight + n) >= v)
												return (
													C.cancelScroll(!0), x(a, t, c), H("scrollStop", i, a, r), !(O = l = null)
												)
									...
									if (history.replaceState && e.updateURL && !history.state) {
										...
										;(t = t || ""),
											history.replaceState(
												{ smoothScroll: JSON.stringify(e), anchor: t || M.pageYOffset },
												document.title,
												t || M.location.href
											)
									}
