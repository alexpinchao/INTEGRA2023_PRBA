...
data_desag_gen_table = Table('DATOS_DESAGREGACION_GENERACION', metadata_obj,
                   ...
                   Column('Eficiencia_de_centrales_hidroeléctricas_[%]', String),
                   Column('Eficiencia_de_centrales_térmicas_[%]', String),
                   Column('Eficiencia_de_centrales_de_auto_y_cogeneración_[%]', String),
                   Column('Eficiencia_de_centrales_solares_[%]', String),
                   Column('Eficiencia_de_centrales_eolícas_[%]', String),
                   Column('Intensidad_energética_primaria_de_centrales_hidroeléctricas_[kWh/USD]', String),
                   Column('Intensidad_energética_primaria_de_centrales_térmicas_[kWh/USD]', String),
                   Column('Intensidad_energética_primaria_de_centrales_de_auto_y_cogeneración_[kWh/USD]', String),
                   Column('Emisiones_de_CO2eq_de_centrales_térmicas_[MtCO2eq]', String),
                   Column('Emisiones_de_CO2eq_de_centrales_de_auto_y_cogeneración_[MtCO2eq]', String),
                   Column('Intensidad_de_emisiones_de_centrales_térmicas_[kgCO2eq/USD]', String),
                   Column('Intensidad_de_emisiones_de_centrales_de_auto_y_cogeneración_[kgCO2eq/USD]', String)
                   )
...
data_desag_end_use_table = Table('DATOS_DESAGREGACION_USO_FINAL', metadata_obj,
                   Column('Año', Integer,
                          nullable=False, unique=True),
                   Column('Consumo_residencial_per_cápita_[MWh/persona]', String),
                   Column('Consumo_per_cápita_urbano_[MWh/persona]', String),
                   Column('Consumo_per_cápita_rural_[MWh/persona]', String),
                   Column('Consumo_residencial_por_vivienda_[MWh/vivienda]', String),
                   Column('Intensidad_energética_del_sector_industrial_[kWh/USD]', String),
                   Column('Intensidad_energética_del_sector_comercial_y_público_[kWh/USD]', String)
                   )
...
_unit_dict = {'Consumo eléctrico por fuente generación': 'GWh',
              ...
              'Intensidad energética primaria de la generación eléctrica [kWh/USD]': 'kWh/USD',
              'Emisiones de CO2eq de la generación eléctrica SIN [MtCO2eq]':'MtCO2eq',
              'Emisiones de CO2eq de la generación eléctrica Total [MtCO2eq]':'MtCO2eq',
              'Intensidad de emisión de la generación eléctrica [gCO2eq/USD]':'gCO2eq/USD',
              'Consumo per cápita [MWh/persona]': 'MWh/persona',
              'Intensidad energética del uso final de la energía eléctrica [kWh/USD]':'kWh/USD',
